...
def upgrade() -> None:
    ...
    op.create_table('request_log_new',
    ...
    sa.Column('status', sa.Enum('unknown', 'healthy', 'offline', 'coming_online', 'needs_attention', name='sitestatus'), nullable=False),
    sa.Column('latitude', sa.Float(), nullable=False),
    sa.Column('longitude', sa.Float(), nullable=False),
    sa.Column('site_type', sa.Enum('unknown', 'urban_background', 'suburban', 'kerbside', 'industrial', 'roadside', 'rural', name='sitetype'), nullable=False),
    ...
    op.create_table('sensor_data_new',
    sa.Column('site_id', sa.Integer(), nullable=False),
